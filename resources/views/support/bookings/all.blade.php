                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <br><small class="text-muted">Alias: {{ $booking->user->alias_name ?? 'N/A' }}</small>
                            ...
                            <td>
                                ...
                                <span class="badge badge-primary">
                                    {{ $booking->segments->first()->pnr ?? $booking->segments->first()->segment_pnr ??
                                    'N/A' }}
                                </span>
                                @endif
                            </td>
                            ...
                            <td>
                                ...
                                @elseif(in_array($booking->status, ['Alert', 'RDR', 'retrieval', 'chargeback',
                                'refund']))
                                <span class="badge bg-danger">{{ ucfirst($booking->status) }}</span>
                                @else
                                <span class="badge bg-secondary">{{ ucfirst(str_replace('_', ' ', $booking->status))
                                    }}</span>
                                @endif
                            </td>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    ...
                                    <!-- Trigger Modal -->
                                    <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#statusModal{{ $booking->id }}">
                                        Status
                                    </button>
