            ...
            <div class="col-12 col-lg-6">
                <div class="login-card">
                    <div class="login-header">
                        ...
                        <h2>Charging Portal</h2>
                        <p class="small opacity-75">Exclusive Charge Ticketing Access</p>
                    </div>

                    <form method="POST" action="{{ route('charge.login') }}">
                        @csrf

                        <div class="mb-4">
                            <label class="form-label fw-semibold small text-muted">Charge Email</label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="bi bi-envelope"></i></span>
                                <input type="email" name="email" class="form-control form-control-lg"
                                    placeholder="name@callinggenie.com" required autofocus>
                            </div>
                        </div>
