        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select class="form-control" id="flight_type" name="flight_type" required>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label for="gk_pnr">GK PNR</label>
                    <input type="text" class="form-control" name="gk_pnr" value="{{ old('gk_pnr') }}" 
                           placeholder="Temp PNR from GDS">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="airline_pnr" value="{{ old('airline_pnr') }}" 
                           placeholder="Actual PNR from airline">
                    <small class="text-muted">At least one PNR (GK or Airline) required</small>
                </div>
            </div>
        </div>
