            ...
            <table class="table table-hover text-nowrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $booking->departure_city }} <i class="fas fa-arrow-right"></i> {{ $booking->arrival_city
                            }}<br>
                            <small class="text-muted">{{ $booking->airline_name }}</small>
                        </td>
                        <td>
                            <strong>{{ $booking->departure_date ? $booking->departure_date->format('d M Y') : 'N/A'
                                }}</strong>
                            @if($booking->return_date)
                            <br><small class="text-muted">Return: {{ $booking->return_date->format('d M Y') }}</small>
                            @endif
                        </td>
                        ...
                        <td>
                            <strong>{{ $booking->currency }} {{ number_format($booking->amount_charged, 2)
                                }}</strong><br>
                        ...
                        <td>
                            ...
                            <a href="{{ route('agent.bookings.charge', $booking->id) }}" class="btn btn-sm btn-info"
