            ...
            <table class="table table-hover text-nowrap">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $booking->departure_city }} <i class="fas fa-arrow-right"></i> {{ $booking->arrival_city }}<br>
                        ...
                        <td>
                            ...
                            <small class="text-success">MCO: {{ $booking->currency }} {{ number_format($booking->total_mco, 2) }}</small>
                        </td>
                        <td>
                            @php
                                $statusClasses = [
...
@endif
                    ...
                    <tr>
                        <td colspan="8" class="text-center py-4">
                            ...
                            <p class="text-muted">No bookings found. <a href="{{ route('agent.bookings.create') }}">Create your first booking</a></p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
